        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200 hover:shadow-md transition-all duration-300 flex flex-col h-full">
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-3 space-y-3">
                    ...
                    <button
                        className="w-full py-3 border-2 border-gray-200 hover:border-blue-300 text-gray-800 font-medium rounded-lg flex items-center justify-center transition-all duration-300"
